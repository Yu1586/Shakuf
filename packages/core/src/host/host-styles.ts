 ...
 *
 * Every rule is gated on a `data-a11y-*` attribute on `<html>`, so a feature is
...
html[data-a11y-line="1"] body *:not(${NO_SPACING}):not(${SELF}) { line-height: 1.6 !important; }
html[data-a11y-line="2"] body *:not(${NO_SPACING}):not(${SELF}) { line-height: 2 !important; }

html[data-a11y-letter="1"] body *:not(${NO_SPACING}):not(${SELF}) { letter-spacing: 0.12em !important; }
html[data-a11y-letter="2"] body *:not(${NO_SPACING}):not(${SELF}) { letter-spacing: 0.2em !important; }

html[data-a11y-word="1"] body *:not(${NO_SPACING}):not(${SELF}) { word-spacing: 0.16em !important; }
html[data-a11y-word="2"] body *:not(${NO_SPACING}):not(${SELF}) { word-spacing: 0.3em !important; }
...
html[data-a11y-font="readable"] body *:not(${NO_SPACING}):not(${SELF}) {
...
html[data-a11y-align="start"] body *:not(${SELF}) {
...
html[data-a11y-contrast="invert"] { filter: invert(1) !important; }
html[data-a11y-contrast="invert"] img,
html[data-a11y-contrast="invert"] video,
html[data-a11y-contrast="invert"] picture {
  /* Cancels the ancestor inversion exactly, so photos stay recognisable. */
  filter: invert(1) !important;
}
html[data-a11y-contrast="mono"] { filter: grayscale(1) !important; }

html[data-a11y-saturation="low"] { filter: saturate(0.5) !important; }
html[data-a11y-saturation="high"] { filter: saturate(1.6) !important; }
...
html[data-a11y-contrast="high"] body *:not(${SELF}):not(svg):not(svg *) {
...
html[data-a11y-contrast="high"] body a:not(${SELF}) { color: #ffe600 !important; }
html[data-a11y-contrast="high"] body a:not(${SELF}):visited { color: #ffb3ff !important; }
html[data-a11y-contrast="high"] body button:not(${SELF}),
html[data-a11y-contrast="high"] body input:not(${SELF}),
html[data-a11y-contrast="high"] body select:not(${SELF}),
html[data-a11y-contrast="high"] body textarea:not(${SELF}) {
  background-color: #000 !important;
  color: #fff !important;
...
/* ---- Highlight links -------------------------------------------------- */
html[data-a11y-links="1"] body a:not(${SELF}) {
...
html[data-a11y-images="hidden"] body img:not(${SELF}),
html[data-a11y-images="hidden"] body picture:not(${SELF}),
html[data-a11y-images="hidden"] body video:not(${SELF}) {
  visibility: hidden !important;
}
html[data-a11y-images="hidden"] body *:not(${SELF}) {
  background-image: none !important;
}

/* ---- Stop motion ------------------------------------------------------ */
html[data-a11y-motion="off"] body *:not(${SELF}),
html[data-a11y-motion="off"] body *:not(${SELF})::before,
html[data-a11y-motion="off"] body *:not(${SELF})::after {
...
html[data-a11y-focus="strong"] body *:not(${SELF}):focus,
html[data-a11y-focus="strong"] body *:not(${SELF}):focus-visible {
...
html[data-a11y-cursor="big"] body *:not(${SELF}) {
...
html[data-a11y-cursor="big"] body a:not(${SELF}),
html[data-a11y-cursor="big"] body button:not(${SELF}),
html[data-a11y-cursor="big"] body [role="button"]:not(${SELF}) {
  cursor: url('data:image/svg+xml;utf8,\
<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 32 32">\
...
const STYLE_ID = 'a11y-il-host-styles';
...
/** Sets or removes `data-a11y-<name>` on `<html>`. */
